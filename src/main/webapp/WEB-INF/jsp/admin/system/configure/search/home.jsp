...
<script>
    ...
    $('#addBtn').on('click', function () {
        ajax.getHtml('${CONFIGURE_SEARCH_ADD_URL}', {SC_ID: '${EXTRA.SC_ID}'}, function (html) {
                model.show({
                    title: '添加配置列表搜索',
                    content: html,
                    ...
                    confirm: function ($model) {
                        ...
                        ajax.post('${CONFIGURE_SEARCH_ADD_URL}', params, function (data) {
    ...
    $dataGridTable.find('tbody').on('click', '#edit', function () {
        ...
        ajax.getHtml('${CONFIGURE_SEARCH_UPDATE_URL}/' + id, {}, function (html) {
                model.show({
                    title: '修改配置列表搜索',
                    content: html,
                    footerModel: model.footerModel.ADMIN,
                    <shiro:hasPermission name="SYSTEM:CONFIGURE_SET_SEARCH_UPDATE_SAVE">
                    isConfirm: true,
                    confirm: function ($model) {
                        var $form = $('#addAndEditForm');
                        //验证
                        ...
                        ajax.put('${CONFIGURE_SEARCH_UPDATE_URL}', params, function (data) {
